...
def _decision_prompt(
    ...
    *,
    ...
    return (
        ...
        "price is not chasing by ema20_distance_atr; a daily level immediately ahead argues "
        "for a nearer target, not for skipping the trade; (2) pullback: the higher-timeframe "
        "trend remains intact and price stabilizes at or reclaims a nearby level with renewed "
