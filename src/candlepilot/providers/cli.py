...
def _decision_prompt(
    ...
    *,
    ...
    return (
        ...
        "treat a short window as noise rather than flow. Judge only from these; if a setup "
        "you are considering needs "
        ...
        "least one of 15m/30m align, price is not already extended into the range edge, and "
        "volume/order flow does not materially contradict; (2) pullback: the higher-timeframe "
        "trend remains intact and price stabilizes at or reclaims a nearby range level with "
        "renewed participation; (3) reversal: price rejects or reclaims a range level plus "
        "momentum or flow confirmation. Overbought or oversold readings alone are never "
