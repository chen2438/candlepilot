...
def _decision_prompt(
    ...
    *,
    ...
    return (
        ...
        "a take profit. Target an effective reward/risk ratio of at least 1.5:1 after fees, "
        "spread, slippage, and exchange price rounding; deterministic risk control rejects "
        "anything below 1.3:1. For ADD, judge the combined position after the add, not the "
        "new quantity in isolation. "
