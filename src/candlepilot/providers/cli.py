...
def _decision_prompt(
    ...
    *,
    ...
    return (
        ...
        "invalidation. portfolio.stop_loss_cooldown_until maps symbols stopped out in the "
        "last 90 minutes to their expiry time; OPEN or ADD on one of those symbols must HOLD "
