...
export { BackupPanel, LogMaintenancePanel, WebUpdatePanel } from "./SettingsPanel";
...
const RISK_DEFINITIONS: Record<string, string> = {
  ...
  "最低盈亏比": "开仓与加仓按实际入场基准、最终风控止损和止盈的价格距离计算下单前盈亏比，必须大于 1.15:1；手续费和滑点不参与该比例，减仓和平仓不受此限制。",
        ...
        <section className="grid overview-grid">
          ...
          <div className="overview-column">
            ...
            <div className="risk-grid">
              ...
              <RiskItem label="最低盈亏比" value="> 1.15:1" detail="风控终值" />
            ...
            <p>模型提示词不包含盈亏比要求；所有开仓必须包含交易所侧止损和止盈，并通过组合风险、下单前盈亏比、精度、陈旧行情和强平缓冲检查。</p>
            ...
            {expanded === decision.id && (
              <div className="decision-detail">
                ...
                <div className="decision-detail-grid">
                  ...
                  <span>模型止损<strong>{intentPrice(decision.intent.stop_loss)}</strong></span>
                  <span data-tooltip="硬风控最终用于定量、盈亏比校验和交易所保护单的止损；适用的结构化趋势突破/延续计划会在模型止损距离上增加 15% 缓冲。">风控止损<strong>{intentPrice(decision.risk?.decision.pre_trade_stop_price ?? null)}</strong></span>
